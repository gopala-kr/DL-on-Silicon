- [DreamDecompiler: Improved Bayesian Program Learning by Decompiling Amortised Knowledge](https://arxiv.org/abs/2306.07856)
...
- [Gen-IR @ SIGIR 2023: The First Workshop on Generative Information Retrieval](https://arxiv.org/abs/2306.02887)
- [PolyVoice: Language Models for Speech to Speech Translation](https://arxiv.org/abs/2306.02982)
- [Seeing is not always believing: Benchmarking Human and Model Perception of AI-Generated Images](https://arxiv.org/abs/2304.13023)
- [ChatGPT vs Human-authored Text: Insights into Controllable Text Summarization and Sentence Style Transfer](https://arxiv.org/abs/2306.07799)
- [Finite Gaussian Neurons: Defending against adversarial attacks by making neural networks say "I don't know"](https://arxiv.org/abs/2306.07796)
- [NoCoLA: The Norwegian Corpus of Linguistic Acceptability](https://arxiv.org/abs/2306.07790)
- [A Cloud-based Machine Learning Pipeline for the Efficient Extraction of Insights from Customer Reviews](https://arxiv.org/abs/2306.07786)
- [A Zero-/Few-Shot Anomaly Classification and Segmentation Method for CVPR 2023 VAND Workshop Challenge Tracks 1&2: 1st Place on Zero-shot AD and 4th Place on Few-shot AD](https://arxiv.org/abs/2305.17382)
...
- [4D Millimeter-Wave Radar in Autonomous Driving: A Survey](https://arxiv.org/abs/2306.04242)
...
- [Recent Advances of Local Mechanisms in Computer Vision: A Survey and Outlook of Recent Work](https://arxiv.org/abs/2306.01929)
- [Unsupervised Domain Adaptation for Anatomical Landmark Detection](http://arxiv.org/abs/2308.13286)
...
- [A Recent Survey of the Advancements in Deep Learning Techniques for Monkeypox Disease Detection](https://arxiv.org/abs/2311.10754)
- [Trustworthy Large Models in Vision: A Survey](https://arxiv.org/abs/2311.09680)
- [Do LLMs exhibit human-like response biases? A case study in survey design](https://arxiv.org/abs/2311.04076)
...
- [Toward Flare-Free Images: A Survey](https://arxiv.org/abs/2310.14354)
...
- [Religious Affiliation in the Twenty-First Century: A Machine Learning Perspective on the World Value Survey](https://arxiv.org/abs/2310.10874)
- [Lincoln AI Computing Survey (LAICS) Update](https://arxiv.org/abs/2310.09145)
- [An experiment on an automated literature survey of data-driven speech enhancement methods](https://arxiv.org/abs/2310.06260)
- [A Large Language Model Approach to Educational Survey Feedback Analysis](https://arxiv.org/abs/2309.17447)
...
------------
- [5 AI trends to look forward to in 2023 and beyond](https://cur.at/eNQSyOQ?m=web)
- [Amazon to Invest up to $4 Billion in AI Firm Anthropic](https://cur.at/ojJ1gwc?m=web)
- [Oracle Incorporates Generative AI Functionality Across Its Fusion Suite](https://cur.at/UWrhIzA?m=web)
- [Google's 10 biggest AI moments so far](https://cur.at/tsCv8zq?m=web)
- [15+ Applications of AI in Business in 2023 (with Examples)](https://cur.at/1UofZa8?m=web)
- [How Do Chatbots Simulate Conversations With People?](https://cur.at/ySbYHYy?m=web)
- [Computer vision's next breakthrough](https://cur.at/J2QFR9P?m=web)
- [European Commission Chief Calls For A Global Panel For Ensuring Safe, Ethical Use Of AI](https://cur.at/kYLTCWM?m=web)
- [Ethical Issues of AI and Fashion](https://cur.at/14pk3Mu?m=web)
- [AI Experts Gather in Austin to Consider Ethics, White Men, and Mass Layoffs](https://cur.at/LJAYOp0?m=web)
- [World's first humanoid robot factory will ship Digits in 2024](https://cur.at/XUa18G3?m=web)
- [5 Incredible AI Humanoid Robots, Some of Which Are Available for Sale Today](https://cur.at/pPp5ri1?m=web)
- [Elon Musk showcases Tesla humanoid robot performing Yoga, Namaste](https://cur.at/kK4Oi6r?m=web)
- [9 free AI tools that run locally on your PC](https://cur.at/q7DIyxb?m=web)
- [Images of simulated cities help AI to understand real streetscapes](https://cur.at/1WrVisY?m=web)
- [IBM Research’s New Prototype AI Chip With 14 Times Energy Efficiency](https://cur.at/vjpAyRR?m=web)
- [ChatGPT Can Now Generate Images, Too](https://cur.at/57X3yJ2?m=web)
...
-------------
- [Jais and Jais-chat: Arabic-Centric Foundation and Instruction-Tuned Open Generative Large Language Models](https://arxiv.org/pdf/2308.16149.pdf)
- [Training Towards Critical Use: Learning to Situate AI Predictions Relative to Human Knowledge](https://arxiv.org/abs/2308.15700)
- [An Experimental Comparison of Partitioning Strategies for Distributed Graph Neural Network Training](https://arxiv.org/pdf/2308.15602.pdf)
- [International Governance of Civilian AI: A Jurisdictional Certification Approach](https://arxiv.org/pdf/2308.15514.pdf)
- [Detect, Augment, Compose, and Adapt: Four Steps for Unsupervised Domain Adaptation in Object Detection](https://arxiv.org/pdf/2308.15353.pdf)
- [CLIPTrans: Transferring Visual Knowledge with Pre-trained Models for Multimodal Machine Translation](https://arxiv.org/pdf/2308.15226.pdf)
- [AI Deception: A Survey of Examples, Risks, and Potential Solutions](https://arxiv.org/abs/2308.14752)
- [Rethinking Mobile AI Ecosystem in the LLM Era](https://arxiv.org/pdf/2308.14363.pdf)
- [On-Premise AIOps Infrastructure for a Software Editor SME: An Experience Report](https://arxiv.org/pdf/2308.11225.pdf)


-------------
- [ChipGPT: How far are we from natural language hardware design](https://arxiv.org/pdf/2305.14019.pdf)
- [Chip-Chat: Challenges and Opportunities in Conversational Hardware Design](https://arxiv.org/pdf/2305.13243.pdf)
- [Energy-frugal and Interpretable AI Hardware Design using Learning Automata](https://arxiv.org/pdf/2305.11928.pdf)
...
- [Adversarial attacks and defenses on ML- and hardware-based IoT device fingerprinting and identification](https://arxiv.org/pdf/2212.14677.pdf)
